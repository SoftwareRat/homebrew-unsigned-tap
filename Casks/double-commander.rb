cask "double-commander" do
  ...
  url "https://github.com/doublecmd/doublecmd/releases/download/v#{version}/doublecmd-#{version.tr(",", "-")}.cocoa.#{arch}.dmg"
  ...
  postflight_steps do
    run "/usr/bin/xattr", args: ["-r", "-d", "com.apple.quarantine", "#{appdir}/Double Commander.app"]
  end
